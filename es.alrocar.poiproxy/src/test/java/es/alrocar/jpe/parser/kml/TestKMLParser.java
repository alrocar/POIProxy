...
public class TestKMLParser extends BaseJSONTest {

	public void testParseKML() {
		System.out.println("=======================================");
		System.out.println("TEST PARSE KML: InfoReyno.kml");
		System.out.println("=======================================");
		...
		ArrayList<JTSFeature> features = kmlParser
				.parse(geoJSON, service, null);
		assertEquals(features.size(), 69);

		System.out.println(kmlParser.getGeoJSON());
	...
	public void testParseKMLWithFilder() {
		System.out.println("=======================================");
		System.out.println("TEST PARSE KML with LocalFilter: InfoReyno.kml");
		System.out.println("=======================================");
		...
		localFilter.value = "Vpo";
		ArrayList<JTSFeature> features = kmlParser.parse(geoJSON, service,
				localFilter);
		assertEquals(features.size(), 58);

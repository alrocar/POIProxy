...
public class DownloaderJson {
	...
	private final static Logger logger = Logger.getLogger(DownloaderJson.class);
	...
	public void downloadFromUrl(String mapURL, Cancellable cancellable) throws Exception {
		...
		try {
			...
			in = new BufferedInputStream(openConnection(mapURL), Constants.IO_BUFFER_SIZE);
	...
	public byte[] downloadFromUrl(String mapURL, String fileName, String downloadPath, Cancellable cancellable)
			throws Exception {
		xmldata = null;
		InputStream in = null;
		OutputStream out = null;
		...
		try {
			...
			fileout.close();
			logger.debug("download ready in" + ((System.currentTimeMillis() - startTime) / 1000) + " sec");
	...
	public void downloadFromUrlBigFile(String mapURL, String fileName, String downloadPath, Cancellable cancellable)
			throws Exception {
		InputStream in = null;
		// OutputStream out = null;
		BufferedInputStream bis = null;
